...
class StopFinderAssignedStop(object):
    ...
    def __init__(self, id=None, name=None, disassembled_name=None, duration=None, distance=None, coord=None, parent=None, type=None, modes=None, connecting_mode=None, _configuration=None):  # noqa: E501
